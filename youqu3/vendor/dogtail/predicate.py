...
from youqu3.vendor.dogtail.i18n import TranslatableString
from youqu3.vendor.dogtail.logging import debugLogger as logger
# from gi.repository import GLib
import importlib

GLib = importlib.import_module(f'youqu3.vendor.gi_{setting.ARCH}.repository')
import re
        ...
        def satisfiedByNode(node):
            try:
                if self.description == None:
                    ...
                    return node.roleName == 'application' and stringMatches(self.appName, node.name) and stringMatches(
